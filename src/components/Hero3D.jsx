  ...
  return (
    <section id="home" className="relative min-h-[92vh] pt-20 flex items-center bg-[#0C1A2B] overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Soft gradient overlay that never blocks pointer events */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          <p className="text-[#F29227] font-semibold tracking-wider uppercase">
            Pakistan's Leading EPS Manufacturer
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#products"
              className="inline-flex items-center gap-2 bg-[#F29227] text-[#111111] font-semibold px-5 py-3 rounded-md shadow hover:bg-[#e1841f] transition"
            >
              Explore Products <ArrowRight className="w-4 h-4" />
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-white/10 text-white hover:bg-white/15 px-5 py-3 rounded-md border border-white/10 transition"
            >
              Request a Quote
            </a>
          </div>
